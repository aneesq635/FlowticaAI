            ...
            >
                  ...
                  {dates.map((d) => {
                    ...
                    return (
                      <TouchableOpacity
                        ...
                        className={`mr-3 items-center justify-center w-16 h-20 rounded-2xl border-2 ${
                          isSelected 
                    ...
                    {timeSlots.map((slot) => {
                      ...
                      return (
                        <TouchableOpacity
                          ...
                          className={`w-[30%] mb-3 py-4 rounded-xl items-center justify-center border ${
                            isSelected
                              ? (isDark ? 'bg-white border-white' : 'bg-slate-900 border-slate-900')
              ...
              <View className="flex-row items-center space-x-3 mt-6">
                ...
                <TouchableOpacity 
                  ...
                  className={`flex-[2] py-5 rounded-3xl items-center justify-center ${
